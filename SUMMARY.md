...
* [💻 Machine](parsers/machine.md)
* [🌍 Network](parsers/network.md)
* [📄 PC Memory](parsers/pc-memory.md)
* [🧠 Processor](parsers/processor.md)
* [🎷 Sound](parsers/sound.md)
* [🖥 System](parsers/system.md)

***

* [🧱 Project Dependencies](project-dependencies.md)
* [Report an issue](https://github.com/Aptivi/Inxi.NET/issues/new)
* [Source code](https://github.com/Aptivi/Inxi.NET)
* [Our projects](https://github.com/Aptivi)
* [API Reference](https://aptivi.github.io/Inxi.NET/)
